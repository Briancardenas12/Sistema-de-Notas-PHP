...
<head>
	...
	<title>Sistemas de Notas Administrador - Agregar</title>
...
<body>
    ...
    <main>
    	<section class="principal">
            <div>
                <h1 class="tituloPrincipal"> Registrar Administador </h1>
            </div>
            <form method="POST" action="../Controlador/add.php">
				...
				<input type="submit" value="Registrar Administrador" class="enviar">
            </form>
        </section>
    </main>
    <footer>
